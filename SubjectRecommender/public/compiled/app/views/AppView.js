    ...
    AppView.prototype.initialize = function() {
      ...
      return this.loginView.on('userInfoReceived', (function(_this) {
        return function(userObject) {
          var index, subject, subjectHash, ref, ref1, user, userHash;
          _this.$el.html('');
          subjectHash = {};
          ref = userObject.allSubjects;
          for (index in ref) {
            subject = ref[index];
          ...
          _(_this.model.get('subList')).extend({
            userObj: userObject
          });
          ...
          _this.subjectView = new SubjectListView({
            model: _this.model.get('subList')
          });
          _this.$('#sidebar').html(_this.subjectView.el);
          ...
          return _this.subjectView.on('newRating', function(ratingObject) {
