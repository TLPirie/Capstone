class window.LoginView extends Backbone.View
  ...
  template:
    '<div class="row" style="margin-top:100px;">
      ...
      <div class="col-lg-4">
      <h1 class="coverheader">What&#39s Next?</h1>
        <blockquote style="font-size: 1.5em;"><em>instant</em> a subject recommendation system for UTS students</blockquote>
        <h1></h1>
        <div class="well">
        ...
        <div class="row">
          ...
          <div class="col-lg-3">
            <div class="coversprites fimage cover2">
              ...
              <p class="covertext ct2">
                <i class="icon-check-sign"></i> Rate your classes!
              </p>
              </div>
            </div>
          </div>
          <div class="col-lg-3">
            <div class="coversprites fimage cover4">
              ...
              <i class="icon-group"></i> See similar classes
              </p>
              </div>
              </div>
          </div>
          <div class="col-lg-3">
            <div class="coversprites fimage cover3">
              ...
              <p class="covertext ct4">
                <i class="icon-film"></i> Get recommendations from similar users
              </p>
              </div>
              </div>
          </div>
